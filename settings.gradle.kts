...
include(":simple-stack-example-basic-kotlin-fragment")
include(":simple-stack-example-basic-kotlin-view")
include(":simple-stack-example-conductor-java")
include(":simple-stack-example-kotlin-community-sample")
include(":simple-stack-example-multistack-view")
include(":simple-stack-example-multistack-fragment")
