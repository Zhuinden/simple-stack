...
public class TasksViewModelTest {
    ...
    public void setupTasksViewModel() {
        ...
        mTasksViewModel = new TasksViewModel(mTasksRepository, mContext);
    ...
    private void setupContext() {
        ...
        when(mContext.getString(R.string.successfully_saved_task_message)).thenReturn("EDIT_RESULT_OK");
        when(mContext.getString(R.string.successfully_added_task_message)).thenReturn("ADD_EDIT_RESULT_OK");
        when(mContext.getString(R.string.successfully_deleted_task_message)).thenReturn("DELETE_RESULT_OK");
