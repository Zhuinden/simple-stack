...
public class AddEditTaskActivity
        ...
        implements AddEditTaskNavigator {
    ...
    private AddEditTaskViewModel findOrCreateViewModel() {
        ...
        // Fragment Manager.
        @SuppressWarnings("unchecked") ViewModelHolder<AddEditTaskViewModel> retainedViewModel = (ViewModelHolder<AddEditTaskViewModel>) getSupportFragmentManager()
        ...
        if(retainedViewModel != null && retainedViewModel.getViewmodel() != null) {
            ...
            AddEditTaskViewModel viewModel = new AddEditTaskViewModel(getApplicationContext(),
