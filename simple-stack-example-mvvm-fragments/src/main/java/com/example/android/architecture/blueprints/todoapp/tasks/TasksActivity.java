...
public class TasksActivity
    ...
    private TasksViewModel findOrCreateViewModel() {
        ...
        // Fragment Manager.
        @SuppressWarnings("unchecked") ViewModelHolder<TasksViewModel> retainedViewModel = (ViewModelHolder<TasksViewModel>) getSupportFragmentManager()
        ...
        if(retainedViewModel != null && retainedViewModel.getViewmodel() != null) {
            ...
            TasksViewModel viewModel = new TasksViewModel(Injection.provideTasksRepository(getApplicationContext()),
