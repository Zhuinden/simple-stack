...
public class TaskDetailActivity
    ...
    private TaskDetailViewModel findOrCreateViewModel() {
        ...
        // Fragment Manager.
        @SuppressWarnings("unchecked") ViewModelHolder<TaskDetailViewModel> retainedViewModel = (ViewModelHolder<TaskDetailViewModel>) getSupportFragmentManager()
        ...
        if(retainedViewModel != null && retainedViewModel.getViewmodel() != null) {
            ...
            TaskDetailViewModel viewModel = new TaskDetailViewModel(getApplicationContext(),
