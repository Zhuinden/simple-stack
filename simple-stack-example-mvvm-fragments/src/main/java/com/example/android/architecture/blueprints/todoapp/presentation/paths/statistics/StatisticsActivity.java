...
import com.example.android.architecture.blueprints.todoapp.presentation.paths.tasks.TasksActivity;
...
public class StatisticsActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statisticsViewModel = findOrCreateViewModel();
    ...
    private StatisticsViewModel findOrCreateViewModel() {
        StatisticsViewModel retainedViewModel = (StatisticsViewModel) getLastCustomNonConfigurationInstance();
