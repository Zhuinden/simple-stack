...
import static com.example.android.architecture.blueprints.todoapp.util.Preconditions.checkArgument;
...
public class TasksScreenTest {
     ...
     */
    @Rule
    public ActivityTestRule<TasksActivity> mTasksActivityTestRule = new ActivityTestRule<TasksActivity>(TasksActivity.class) {
    ...
    public void editTask()
        ...
        onView(withId(R.id.add_task_title)).perform(replaceText(editTaskTitle), closeSoftKeyboard()); // Type new task title
    ...
    public void orientationChange_DuringEdit_ChangePersists()
        ...
        onView(withId(R.id.add_task_title)).perform(replaceText(TITLE2), closeSoftKeyboard()); // Type new task title
    ...
    private void createTask(String title, String description) {
        ...
        onView(withId(R.id.add_task_title)).perform(typeText(title), closeSoftKeyboard()); // Type new task title
    ...
    private String getToolbarNavigationContentDescription() {
        return TestUtils.getToolbarNavigationContentDescription(mTasksActivityTestRule.getActivity(), R.id.toolbar);
    }
}
