...
public class MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multistack.add(CLOUDSYNC.name(), BackstackDelegate.create());
        multistack.add(CHROMECAST.name(), BackstackDelegate.create());
        multistack.add(MAIL.name(), BackstackDelegate.create());
        multistack.add(LIST.name(), BackstackDelegate.create());
    ...
    private void exchangeViewForKey(Key newKey, int direction) {
        ...
        BackstackDelegate backstackDelegate = newKey.selectDelegate(this);
