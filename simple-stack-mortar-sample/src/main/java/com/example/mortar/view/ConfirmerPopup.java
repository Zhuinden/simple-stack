...
public class ConfirmerPopup
        implements Popup<Confirmation, Boolean> {
    ...
    @Override
    public void show(Confirmation info, boolean withFlourish, final PopupPresenter<Confirmation, Boolean> presenter) {
        if(dialog != null) {
